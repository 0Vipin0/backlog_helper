...
class UpdateCommand extends Command<void> {
  ...
  final String description =
      'Update an existing item (task, goal, plan, obstacle) in the Excel file.';
  ...
  UpdateCommand({ExcelService? excelService, this.interactive = false})
    ...
    addSubcommand(UpdateTaskCommand(
        excelService: _excelService, interactive: interactive));
    addSubcommand(UpdateGoalCommand(
        excelService: _excelService, interactive: interactive));
    addSubcommand(UpdatePlanCommand(
        excelService: _excelService, interactive: interactive));
    addSubcommand(UpdateObstacleCommand(
        excelService: _excelService, interactive: interactive));
  }
